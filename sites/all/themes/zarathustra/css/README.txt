...
To use these stylesheets, rename the files and zarathustra with the name of your theme.
...
zarathustra-alpha-default-narrow.css  
...
zarathustra-alpha-default-normal.css
...
zarathustra-alpha-default-wide.css
